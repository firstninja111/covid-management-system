...
class SettingsController extends Controller
{
    ...
    public function stripePaymentUpdate(Request $request)
    {
        ...
        $data = [
            'app_paypal' => $request->app_paypal,
        ];

        $this->updateSettings($data);

        return redirect()->back()->with('success', 'Paypal Billing Address Updated Successfully');
    }

    public function defaultLocationUpdate(Request $request)
    {
        $data = [
    ...
    public function timeSlotUpdate(Request $request)
    {
        ...
        {
            return redirect()->back()->with('success', 'End time can not be ahead of start time');
        } else {
            $this->updateSettings($data);
