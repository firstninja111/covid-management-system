...
<body style="background:url({{public_path('uploads/appLogo/pdf-background.png')}}) no-repeat;background-size:cover !important">
    ...
    <table style="border-collapse: collapse; width:100%; padding: 15px 90px 10px 90px;">
        ...
        <tr>
            ...
            <td valign="top">
                <p style="font-size: 14px; font-weight: bold;">{{$result_type != 'Positive/Negative' ? $result : ($result == 'Positive' ? $positive_display : ($result == 'Negative' ? $negative_display : $inconclusive_display)) }}</p>
            </td>
        </tr>
        <tr>
            <td></td>
