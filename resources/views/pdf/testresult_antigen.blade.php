...
<body style="background:url({{public_path('uploads/appLogo/pdf-background.png')}}) no-repeat;background-size:cover !important">
    ...
    <p style="font-size: 14px; margin-left: 60px; margin-right:60px; margin-bottom:10px;">A Not Detected (negative) test result for this test means that SARS-CoV-2 nucleocapsid antigens were not present in the
        specimen above the limit of detection. A negative result does not rule out the possibility of COVID-19 and should not be used
        as the sole basis for treatment or patient management decisions. If COVID-19 is still suspected, based on exposure history
        together with other clinical findings, re-testing should be considered in consultation with public health authorities. Laboratory
        test results should always be considered in the context of clinical observations and epidemiological data in making a final
        diagnosis and patient management decisions.</p>
    
    <p style="font-size: 14px; margin-left: 60px; margin-right:60px; margin-bottom:10px;">A Detected (positive) test result indicates that the SARS-CoV-2 nucleocapsid antigens are detectable in upper and lower
        respiratory specimens during infection. Positive results are indicative of active infection with SARS-COV-2, but do not rule
        out bacterial infection or co-infection with other viruses. The agent detected may not be the definite cause of disease. This
        test is intended for the qualitative detection of nucleic acid from the SARS-COV-2 virus in upper and lower respiratory
        specimens collected from individuals who meet CDC criteria.</p>
    ...
    <p style="font-size: 14px; margin-left: 60px; margin-right:60px; margin-bottom:10px;">Methodology: Qualitative detection of SARS-CoV-2 nucleocapsid antigens in nasal swabs from individuals who are
        suspected of COVID-19.</p>
