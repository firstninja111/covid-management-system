                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <div style="text-align:center">
                        <iframe id="previewIframe" src="https://docs.google.com/viewer?url={{asset($template->preview_url)}}&embedded=true" frameborder="0" height="1100" width="100%"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-12 mb-2">
                                ...
                                <hr>
                              <input type="text" name="templateId" class="form-control" value="{{$template->id}}" id="templateId" hidden>

                              <div class="col-md-12">
                                <div class="form-row mb-2">
                                  <div class="col-sm-12">
                                     <label for="name" class="mb-1">{{__('app.template_name')}}</label>
                                      <input type="text" name="name" value="{{$template->name}}" placeholder="{{__('app.template_name')}}" class="form-control" id="name" required>
                                      @error('name')
                                ...
                                <div class="mb-2">
                                  ...
                                  <div class="d-flex" id="result_type_group">
                                    <input type="radio" name="result_type" value="Positive/Negative" id="result_type1" style="width: 30px; height:16px; margin-top:5px;" {{$template->result_type == "Positive/Negative" ? 'checked' : ''}}>
                                    <label for="result_type1" class="form-check-label mb-1" style="font-size:16px; margin-right: 20px;">Positive/Negative</label>

                                    <input type="radio" name="result_type" value="Number/Score" id="result_type2" style="width: 30px; height:16px; margin-top:5px;" {{$template->result_type == "Number/Score" ? 'checked' : ''}}>
                                ...
                                <div class="form-row mb-2" id="result_type_section" style="{{$template->result_type != 'Positive/Negative' ? 'display: none;' : ''}}">
                                  <div class="col-sm-4">
                                      <label for="positive_display" class="mb-1">{{__('app.positive_display')}}</label>
                                      <input type="text" name="positive_display" value="{{$template->positive_display}}" placeholder="non-reactive (Negative)" class="form-control" id="positive_display">
                                  ...
                                  <div class="col-sm-4">
                                     <label for="negative_display" class="mb-1">{{__('app.negative_display')}}</label>
                                      <input type="text" name="negative_display" value="{{$template->negative_display}}" placeholder="reactive (Preliminary Positive)" class="form-control" id="negative_display">
                                  ...
                                  <div class="col-sm-4">
                                     <label for="inconclusive_display" class="mb-1">{{__('app.inconclusive_display')}}</label>
                                      <input type="text" name="inconclusive_display" value="{{$template->inconclusive_display}}" placeholder="pending (Inconclusive)" class="form-control" id="inconclusive_display">
                                ...
                                <div class="mb-4">
                                  <div class="d-flex">
                                    <input type="checkbox" name="qr_code" id="qr_code" style="width: 30px; height:16px; margin-top:5px;" {{$template->qr_code == 1 ? 'checked' : ''}}>
                                ...
                                <div class="form-row mb-2">
                                  ...
                                  <div class="col-sm-6">
                                    <button id="button_submit" type="submit" class="btn btn-danger col-md-12">{{__('app.save')}}</button>
                                  </div>
                                </div>
                              </div>
                            </div>
