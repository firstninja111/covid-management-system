                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                              <div class="table-responsive no-padding">
                                    ...
                                    <tr>
                                      ...
                                      <td>{{date('d-m-Y h:i',$plan['start_date'])}}</td>
                                    </tr>
                                    <tr>
                                      <td class="ml-5">{{__('app.plan_expiring_date')}}</td>
                                      <td>{{date('d-m-Y h:i',$plan['end_date'])}}</td>
                                    </tr>
                    							</table>
                            </div>
                        </div>
                        <div class="col-md-12 mx-auto mt-3">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <button type="button" class="btn btn-danger col-md-12 text-white" data-toggle="modal" data-target="#cancelSub">{{__('app.cancel_subscription')}}</button>
                              <div class="modal fade" id="cancelSub" tabindex="-1" role="dialog" aria-labelledby="cancelSubLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-body text-center">
                                      <h3 class="mb-4">{{__('app.please_confirm')}}</h3>
                                      <p class="mb-5">{{__('app.subscription_confirm_cancel')}}</p>
                                      <a href="/subscription-cancel/{{$plan['subscriptionId']}}" class="btn btn-danger col-md-6 pull-right text-white">{{__('app.cancel_subscription')}}</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
