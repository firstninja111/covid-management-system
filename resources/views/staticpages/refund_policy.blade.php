...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li><a class="nav-link scrollto " href="{{route('home')}}">Home</a></li>
          ...
          <li><a class="nav-link scrollto active" href="{{route('refund_policy')}}">Refund Policy</a></li>
  ...
  <main id="main" style="padding-top: 150px; padding-left: 15%; padding-right: 15%; padding-bottom: 100px;">
    ...
    <h2 style="text-align:center; font-family: sans-serif; margin-bottom: 40px;">Cancellation and Refund Policy</h2>

    <p>Your appointments are very important to the members of Rapid-Labs. The time slot is reserved especially for you. We understand that sometimes schedules adjustments are necessary; therefore, we respectfully request at least 24 hours’ notice for cancellations. </p> 
    <p>Cancellations are accepted at any time up to your appointment day, at which point if you cannot attend your requested time slot you can either forfeit your appointment or reschedule. As a reminder, we send reminder emails and text message (local phones only).</p>

    <p style="font-weight:bold; margin-top: 50px;">STRICT AND ENFORCED 24 HOUR CANCELLATION POLICY!</p>
    <p>Please understand that when you forget or cancel your appointment without giving enough notice, we miss the opportunity to fill that appointment time, and clients on our waiting list miss the opportunity to receive services. Our appointments are confirmed via multiple emails and reminders in advance.  Since the services are reserved for you personally, a cancellation fee will apply.</p>

    <p style="font-weight:bold">Cancellation Fees:</p>
    <p>- Less than 72 hours’ notice will result in a charge equal to 50% of the service amount.</p>
    <p>- “NO SHOWS” will be charged 100% of the reserved service amount.</p>
    <p>- Same day cancellations will be charged 100% of the reserved service amount.</p>
    <p>- More than 72 hours in advance notice will result in a charge of a $50 fee.</p>

    <p style="font-weight:bold">Rescheduling:</p>
    <p>We offer unlimited free rescheduling of your appointment to any given time slot.</p>

    <p style="font-weight:bold">Refund Policy:</p>
    <p>Customer agrees that all transactions are non-refundable. Unless adhered to cancellation policy. Rapid-Labs agrees to render services as purchased by customer. Customer understands that delays or situations that are out of our control are not grounds for a refund. Satisfaction is not determined by results or timing of reports. it is the customers responsibility to follow up with the lab to find out if the results have been sent out correctly. Rapid-Labs is not responsible for results ending up in Spam or being delayed.</p>

    <p style="font-weight:bold; margin-top:40px;">ALL SERVICES ARE NON-REFUNDABLE.</p>
