                          ...
                          <div class="table-responsive no-padding">
                              ...
                              <tbody>
                                @if(count($users))
                        					...
                        					<tr>
                                    <td>{{$user->id}}</td>
                                    <td><img class="img-fluid rounded-circle" width="40px" src="{{($user->avatar)? $user->avatar : asset('public/uploads/avatar/avatar.png')}}" alt="icon"></td>
                        						<td><a href="{{route('user.edit',$user->id)}}">{{$user->lastname. ' '. $user->firstname}}</a></td>
                        						<td>{{$user->username}}</td>
                        						<td>{{$user->email}}</td>
                                    <td>{{$user->roles->first()->name}}</td>
                                        ...
                                        <div class="d-inline-block">
                                          @if($user->roles->first()->name == 'users')
